...
import Dashboard.ReceptionistDashboardGUI;
...
public class ReceptionistLoginGUI extends JFrame {
	...
	public ReceptionistLoginGUI() {
		...
		lblExit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(JOptionPane.showConfirmDialog(null, "Do you really want to close this app?", "Confirm", JOptionPane.YES_NO_OPTION)== 0) {
					ReceptionistLoginGUI.this.dispose();
				}
			}
			@Override
		...
		lblBox.setIcon(new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/square.png")));
		...
		panelSignInButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				result = new CRUD().receptionistLogin(user);
		...
		Image signin_img = (new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/signin.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH));
		...
		Image password_img = new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/password.png")).getImage().getScaledInstance(32,32,Image.SCALE_SMOOTH);
		...
		Image username_img = (new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/username.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH));
		...
		lblLogo.setIcon(new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/logo (1).png")));
		...
		lblBackground.setIcon(new ImageIcon(ReceptionistLoginGUI.class.getResource("/resources/backgroundgreen.jpg")));
