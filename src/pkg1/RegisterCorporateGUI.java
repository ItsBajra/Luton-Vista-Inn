...
public class RegisterCorporateGUI extends JFrame {
	...
	public RegisterCorporateGUI() {
		...
		lblExit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(JOptionPane.showConfirmDialog(null, "Do you really want to close this app?", "Confirm", JOptionPane.YES_NO_OPTION)== 0) {
					RegisterCorporateGUI.this.dispose();
				}
			}
			@Override
		...
		txtCompanyName.setBounds(523, 96, 308, 31);
		...
		lblCompanyName.setBounds(523, 82, 141, 14);
		...
		JLabel lblAccountTypeIndividual = new JLabel("Account Type: Corporate Account");
		...
		btnSubmit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				new CRUD().corporateinsert(FirstName, LastName, Email, CompanyName, ContactNumber, Address, City, ZipCode, Country, Password, CCNumber, NameOnCard, ExpiryDate, CVVCode);
				clearAll();
		...
		lblEnterAPassword.setBounds(524, 174, 141, 14);
		contentPane.add(lblEnterAPassword);
		
		txtPassword = new JTextField();
		txtPassword.setBorder(null);
		txtPassword.setColumns(10);
		txtPassword.setBounds(524, 188, 308, 31);
		...
		JLabel lblEnterYourCredit = new JLabel("Enter your credit card details ");
		...
		lblSetUpA.setBounds(525, 146, 307, 14);
		...
		lblbox2.setIcon(new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/SquareStretched.png")));
		...
		lblbox1.setIcon(new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/SquareStretched.png")));
		...
		Image signin_img = (new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/signin.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH));
		Image password_img = new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/password.png")).getImage().getScaledInstance(32,32,Image.SCALE_SMOOTH);
		Image username_img = (new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/username.png")).getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH));
		
		JLabel lblBackground = new JLabel("");
		lblBackground.setIconTextGap(0);
		lblBackground.setHorizontalTextPosition(SwingConstants.CENTER);
		lblBackground.setIcon(new ImageIcon(RegisterCorporateGUI.class.getResource("/resources/backgroundgreen.jpg")));
